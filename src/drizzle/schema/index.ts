import route, { NewRoute, Route } from './route';
import routeImage, { NewRouteImage, RouteImage } from './route-image';
import routePoint, {
  NewRoutePoint,
  RoutePoint,
  routePointTypeEnum,
} from './route-point';
import routePointImage, {
  NewRoutePointImage,
  RoutePointImage,
} from './route-point-image';
import routePointRating, {
  NewRoutePointRating,
  RoutePointRating,
...
import routePointUpvote, {
  NewRoutePointUpvote,
  RoutePointUpvote,
} from './route-point-upvote';
